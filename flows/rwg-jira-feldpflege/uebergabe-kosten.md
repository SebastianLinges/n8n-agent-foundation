...
**Die Maschinenregel ist ein nativer Filter-Node, kein Code.** `Maschinentickets aussortieren` sitzt direkt hinter dem Trigger; Konten, Adressen und Muster stehen als fünf Bedingungen in der Oberfläche. Neue Adressen werden dort ergänzt, nicht im Code. Belegt in Lauf 114939 und lokal gegen 200 echte Tickets.
...
| 114939 | Filter-Node: Defender-Kommentar und Monitoring-Feldänderung aussortiert, Siemensring-Ticket durchgelassen | 262 ms, alle drei wie entworfen |
