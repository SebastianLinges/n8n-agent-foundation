...
| Monitor Graph & Teams | naechste 15 Minuten | `rwg_automate@rwg-r.de` hat am 04.09. eine Office-365-Lizenz bekommen. Der Healthcheck hatte bei jedem Lauf gemeldet, dass sie fehlt, und jedes Mal `Telegram_Error_Info` gezogen. Laeuft er jetzt gruen durch? Wenn nicht, steckt ein zweites Problem dahinter |
